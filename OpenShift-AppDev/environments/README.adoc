...
* *Denver* : February 13
** link:http://console-openshift-console.apps.cluster-colorado-f432.colorado-f432.open.redhat.com[Openshift Master Console^]
** link:http://codeready-che.apps.cluster-colorado-f432.colorado-f432.open.redhat.com[Code Ready Console^]
** Openshift API for command line 'oc' client: https://api.cluster-colorado-f432.colorado-f432.open.redhat.com:6443
