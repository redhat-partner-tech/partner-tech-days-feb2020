...
To get started, link:http://codeready-che.apps.cluster-cinci-5f0d.cinci-5f0d.open.redhat.com[*access the Che instance*] and log in using the username and password you've been assigned (e.g. *userNN/passNN*):
